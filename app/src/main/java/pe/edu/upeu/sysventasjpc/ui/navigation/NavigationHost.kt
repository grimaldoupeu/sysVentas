...
=======
    ...
    NavHost(
        ...
        composable(
            route = Destinations.Pantalla2.route,
        ...
        composable(Destinations.ProductoMainSC.route){
            ProductoMain(navegarEditarAct = {newText-> navController.navigate(Destinations.ProductoFormSC.passId(newText))},
                navController =navController )
        }
        composable(Destinations.ProductoFormSC.route, arguments =
            ...
            ProductoForm(text = prodId, darkMode = darkMode,navController=navController )
        }
